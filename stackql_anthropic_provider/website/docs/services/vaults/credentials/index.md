...
<tr id="parameter-limit">
    ...
    <td>Maximum number of credentials to return per page. Defaults to 20, maximum 100.</td>
</tr>
<tr id="parameter-page">
    <td><CopyableCode code="page" /></td>
    <td><code>string</code></td>
    <td>Opaque pagination token from a previous `list_credentials` response.</td>
</tr>
