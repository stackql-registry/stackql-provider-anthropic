...
// (stackql-provider-<name-sans-underscores>) doesn't apply here.
config.projectName = 'stackql-provider-anthropic';
config.presets[0][1].docs.editUrl =
  'https://github.com/stackql-registry/stackql-provider-anthropic/edit/main/stackql_anthropic_provider/website/';
